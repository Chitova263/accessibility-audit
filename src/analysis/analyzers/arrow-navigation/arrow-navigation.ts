...
import type { Impact, RuleId } from '../../registry/rule-catalog';
 ...
 */
export function analyzeReadingOrderLandmarkSequence({ transcript }: AuditContext): ReadingOrderLandmarkSequenceResult {
    const violations: NvdaViolation[] = [];
