...
├── link-text/              # generic-link-text, duplicate-link-text, fragmented-link-text
├── content-structure/      # large-content-gap, landmark-without-heading, steps-to-main-content,
│                           # excessive-repetition, unexited-subtree-repetition, excessive-blank-announcements,
│                           # repeated-pattern-without-heading, reading-order-landmark-sequence,
│                           # excessive-navigation-links, content-density-per-region
├── interactive-elements/   # empty-accessible-name, aria-hidden-focusable, form-field-no-label,
│                           # missing-skip-link, nested-interactive-elements
